...
Hi, I'm **0xLichSec**. I'm working through the [Cyfrin Updraft](https://updraft.cyfrin.io/) curriculum to sharpen my smart contract auditing skills, and this repository documents my progress along the way. You can follow more of my day-to-day updates on X: [@0xLichSec](https://x.com/0xLichSec).

This particular repo is the **Cyfrin Updraft Fund Me project** – you can find the official course materials here: *[⭐️ Updraft | Foundry Fund Me](https://updraft.cyfrin.io/courses/foundry/foundry-fund-me/fund-me-project-setup)*. I'm customizing the project and notes to serve as my personal reference as I level up toward professional audits.

# About

This repository contains a minimal on-chain crowdfunding workflow built with Foundry. Contributors can send ETH to the contract owner as long as their contribution meets a USD-denominated threshold. A Chainlink price feed powers the ETH/USD conversion, and all contributors are tracked on-chain so the owner can reset state or reward past supporters later. Scripts and tests demonstrate how to deploy, fund, and withdraw across local chains, Sepolia, and zkSync environments.
...
```
git clone https://github.com/0xLichSec/FoundryFundMe
cd FoundryFundMe
make
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/0xLichSec/FoundryFundMe)
...
If you’re enjoying the writeups or want to see more of my Cyfrin Updraft progress, come say hi:

- [X (Twitter) — @0xLichSec](https://x.com/0xLichSec)
- [GitHub — 0xLichSec](https://github.com/0xLichSec)

Tips and collaborations are always welcome—just DM me on X for the latest address or contact details.

# Donation Addresses

If you’d like to support this work directly, you can send contributions to the addresses below. Every donation goes toward deeper research, better tooling, and more thorough educational content.

- ETH: `0xb37d84172d8eb79827e14adde1be9491c006715c`
- BTC: `bc1q5hess99t5mswrmep9v6r8xm955ftzgssakd2f0`
- SOL: `GPwAoPtAMvi2dHtFMWyTbJS7oSsQeBCW9Wacd2VnE581`
