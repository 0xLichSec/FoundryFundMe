...
// Validates that the helper modifiers from foundry-devops behave like we expect and documents how to run these cross-tooling checks.
contract ZkSyncDevOps is Test, ZkSyncChainChecker, FoundryZkSyncChecker {
    ...
    function testZkSyncChainFails() public skipZkSync {
        ...
        bool success;
        // This direct CALL uses an arbitrary precompile address to prove cheatcodes are functional on standard EVM chains.
        assembly {
